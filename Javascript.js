...
export function getBSS1815Answer(question){
  ...
  if(currentLangQA==="fra") return "Je ne comprends pas. Ecrivez AGENT.";
  if(currentLangQA==="eng") return "I don't understand. Type AGENT.";
  return "Mwen pa konprann. Ekri AJAN pou yon moun.";
}
